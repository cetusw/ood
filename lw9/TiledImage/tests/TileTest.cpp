...
{
	constexpr Color bg = ToColor(100, 100, 100);
	const Tile tile(bg);
...
{
	Tile tile(0);
	constexpr Point p = { 4, 4 };
	constexpr Color color = ToColor(255, 0, 0);
...
{
	constexpr Color c1 = ToColor(1, 1, 1);
	constexpr Color c2 = ToColor(2, 2, 2);
...
{
	const int initialCount = Tile::GetInstanceCount();
	{
		Tile t1(0);
